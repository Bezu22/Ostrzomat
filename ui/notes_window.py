...
class NotesWindow(ctk.CTkToplevel):
    def __init__(self, parent, current_text, on_save_callback):
        ...
        # Kontener główny
        self.main_frame = ctk.CTkFrame(self, corner_radius=15, border_width=2, border_color="#e67e22")
        self.main_frame.pack(fill="both", expand=True, padx=10, pady=10)
        
        # Nagłówek
        self.lbl_title = ctk.CTkLabel(self.main_frame, text="ZARZĄDZANIE UWAGAMI", font=("Arial", 14, "bold"), text_color="#e67e22")
        ...
        self.txt_notes = ctk.CTkTextbox(self.main_frame, height=100, width=390, font=("Arial", 12))
        ...
        self.btn_save = ctk.CTkButton(btn_frame, text="ZAPISZ", fg_color="#28a745", hover_color="#218838", width=180, command=self.save_notes)
        self.btn_save.pack(side="left", padx=5, expand=True)
        
        self.btn_cancel = ctk.CTkButton(btn_frame, text="ANULUJ", fg_color="#c0392b", hover_color="#a93226", width=180, command=self.destroy)
        self.btn_cancel.pack(side="right", padx=5, expand=True)
        
        # Pierwsza synchronizacja stanu pola tekstowego
        self.toggle_textbox()
    ...
    def save_notes(self):
        """Wyciąga tekst, czyści zbędne entery i przekazuje wyżej."""
        # Pobieramy tekst (strip usuwa znak nowej linii dodawany domyślnie przez Tkinter)
