...
class PriceEditor(ctk.CTkToplevel):
    ...
    def show_status(self, message, color=Style.COLOR_SUCCESS):
    ...
    def on_row_select(self, data, frame):
        ...
        self.selected_frame.configure(fg_color=Style.COLOR_ROW_SELECTED)
    ...
    def delete_action(self):
        if messagebox.askyesno("Usuń", "Na pewno usunąć wybrany rekord?"):
            ...
            self.refresh_list()
            self.show_status("REKORD USUNIĘTY", color=Style.COLOR_DANGER)
